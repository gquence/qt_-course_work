...
try
{
    ...
    {
        case "POST":
#curl -d "type=POST&login=test_ped_1&pass=pedago_pass&name=pedago&surname=sur_pedago&sOp=false" localhost/t_users/CRUD_user.php 
            insert_lessson($_POST);
            break;
        case "PATCH":
